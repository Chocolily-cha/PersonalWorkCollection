...
export const works: Work[] = [
...

  {
    ...
    mediaFiles: [
      createMediaFile('ADAS技术综合实训室.png', '模型'),
      createMediaFile('室外综合实训测试场.jpg', '模型'),
      createMediaFile('效果图1.png', '模型'),
      createMediaFile('效果图2.png', '模型'),
      createMediaFile('效果图3.png', '模型'),
      createMediaFile('效果图5.png', '模型'),
      createMediaFile('效果图6.png', '模型'),
      createMediaFile('效果图7.png', '模型'),
      createMediaFile('学校.jpg', '模型'),
      createMediaFile('电脑室.jpg', '模型'),
    ],
  },
  {
    id: generateId(),
    ...
    mediaFiles: [
      createMediaFile('台架教学区.png', '模型'),
      createMediaFile('实验室效果图-总览.png', '模型'),
      createMediaFile('智能汽车创客实训室.png', '模型'),
      createMediaFile('智能网联汽车测试装调实训室.png', '模型'),
      createMediaFile('智能网联综合培训室.png', '模型'),
      createMediaFile('车联网系统集成实训室.png', '模型'),
    ],
  },
  {
    id: generateId(),
    ...
    mediaFiles: [
      createMediaFile('ADAS高级辅助驾驶检测综合实训室.png', '模型'),
      createMediaFile('总览.jpg', '模型'),
      createMediaFile('无人驾驶仿真测试实训室.png', '模型'),
      createMediaFile('车联网综合技术实训室.png', '模型'),
      createMediaFile('车路协同实训区.png', '模型'),
      createMediaFile('车辆远程大数据云控中心.png', '模型'),
    ],
  },
  {
    id: generateId(),
  ...
  },
  {
    ...
    mediaFiles: [
      createMediaFile('区域1-1+X考核.jpg', '模型'),
      createMediaFile('区域2-台架区.jpg', '模型'),
      createMediaFile('区域3-线控区.jpg', '模型'),
      createMediaFile('区域4-沙盘区.jpg', '模型'),
      createMediaFile('区域5-底盘区.jpg', '模型'),
      createMediaFile('总图.png', '模型'),
    ],
  },
  {
    id: generateId(),
    ...
    mediaFiles: [
      createMediaFile('先进传感器感知-大数据中心.png', '模型'),
      createMediaFile('先进传感器感知-标定中心.png', '模型'),
      createMediaFile('先进传感器感知-鉴定中心.png', '模型'),
      createMediaFile('先进传感器感知.png', '模型'),
    ],
  },
  {
    id: generateId(),
    ...
    mediaFiles: [
      createMediaFile('ADAS技术综合实训室(1).png', '模型'),
      createMediaFile('ADAS技术综合实训室(2).png', '模型'),
      createMediaFile('ADAS技术综合实训室.png', '模型'),
      createMediaFile('ADAS高级辅助驾驶检测综合实训室.png', '模型'),
    ],
  },
  {
    ...
    mediaFiles: [
      createMediaFile('智能车嵌入式应用创新实训室 (2).png', '模型'),
      createMediaFile('智能车嵌入式应用创新实训室(1).png', '模型'),
      createMediaFile('智能车嵌入式应用创新实训室.png', '模型'),
      createMediaFile('智能车嵌入式编程实训室.png', '模型'),
    ],
  },
  {
    id: generateId(),
    ...
    mediaFiles: [
      createMediaFile('道路管理系统-交叉路口管理系统.png', '模型'),
      createMediaFile('道路管理系统.png', '模型'),
    ],
  },
  {
    id: generateId(),
    ...
    mediaFiles: [
      createMediaFile('雷达实验室-1.png', '模型'),
      createMediaFile('雷达实验室-2.png', '模型'),
      createMediaFile('雷达实验室-3.jpg', '模型'),
    ],
  },
  {
    id: generateId(),
    ...
    mediaFiles: [
      createMediaFile('1.png', '模型'),
      createMediaFile('2.png', '模型'),
      createMediaFile('3.png', '模型'),
    ],
  },
  {
    id: generateId(),
    ...
    mediaFiles: [
      createMediaFile('智能网联汽车传感器装调平台.png', '模型'),
      createMediaFile('智能网联汽车计算单元平台.png', '模型'),
      createMediaFile('视频识别.png', '模型'),
    ],
  },
  {
    id: generateId(),
    ...
    mediaFiles: [
      createMediaFile('智能识别.jpg', '模型'),
      createMediaFile('红绿灯.jpg', '模型'),
    ],
  },
  ...[
    '上海建筑.jpg',
  ...
  ...[
    ...
    '人像——辣辣/4.jpg',
    '人像——辣辣/5.jpg',
    '风景——深圳人才公园/DSC_1257.JPG',
    '风景——深圳人才公园/DSC_1258.JPG',
    '风景——深圳人才公园/DSC_1262.JPG',
    '风景——深圳人才公园/DSC_1890.JPG',
  ].map(filename => ({
    id: generateId(),
    title: filename.replace(/\.(jpg|JPG)$/, ''),
    ...
    tools: ['摄影', 'Lightroom'],
    description: '摄影作品。',
    mediaFiles: [createMediaFile(filename, '摄影')],
  })),
