...
export const works: Work[] = [
  ...
  ...[
    ...
    id: generateId(),
    title: filename.replace(/\.(jpg|png)$/, '').replace(/^(单体模型|MHXCZYZZ项目效果图)\//, ''),
    category: '模型' as Category,
    createdAt: '',
  ...
  ...[
    ...
    '20200911公司海报第四版.jpg',
    '公司智能网联汽车实训基地海报/公司智能网联汽车实训基地海报-1.jpg',
    '公司智能网联汽车实训基地海报/公司智能网联汽车实训基地海报-2.jpg',
    '公司智能网联汽车实训基地海报/公司智能网联汽车实训基地海报-3.jpg',
    '产品使用说明封面设计.jpg',
    '工具图标.png',
    '教材封面设计.png',
    '智能网联文化墙设计图.jpg',
    ...
    id: generateId(),
    title: filename.replace(/\.(jpg|png)$/, '').replace(/^公司智能网联汽车实训基地海报\//, ''),
